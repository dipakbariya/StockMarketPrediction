...
#     y = list(A.Cloe)
    ...
    return render_template('index.html',prediction_text='Predicted Close Price for {} stock is $ {}'.format(hashtag1, round(pred[0][0],2)), script='{}'.format(script), div='{}'.format(div), plot1='{}'.format(plt.plot(A.inex, A.Close, linewidth=1)))
